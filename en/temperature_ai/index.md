...
**Heads up! The correctness of your graph cannot be checked using checkpy. Checkpy _will only_ check whether a graph is shown (or saved).**
...
**Note that _not all tests will pass_ unless you also implement the temperature "challenge" assignment.** This challenge is optional, and can be found in the module menu. _It is okay if the "prints the first year that had a heatwave" test fails!_
